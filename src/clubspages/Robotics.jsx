  ...
  return (
    <div className='clubpages' style={{ height: "100vh" }} >
      ...
      <div className="clubpages_title mt-5">
        <h1 style={{ borderBottom: '0.3rem solid green', borderRadius: '5px' }}>ROBOTICS</h1>
      </div>
